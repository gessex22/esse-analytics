...
//
// El escaneo corre ANTES de responder (no en background): el catálogo recién creado no
// tiene platforms (un archivo en disco no sabe dónde se publicó), así que el caller debe
// poder hacer un pull inmediatamente después de recibir la respuesta para recuperar esa
// info desde la nube — si el scan siguiera en background, el pull llegaría antes de que
// las filas existan y las trataría como huérfanas en vez de recuperarlas.
